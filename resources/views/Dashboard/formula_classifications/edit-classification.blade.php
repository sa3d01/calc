...
@section('title', 'Formula Classification')
@section('styles')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    @endif
                    <div class="card-box">
                        <form method="POST" action="{{route('admin.formula_content.update_classification',$row->id)}}" enctype="multipart/form-data" data-parsley-validate novalidate>
                            @csrf
                            @method('PUT')
