        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    @endif
                    <div class="card-box">
                        <form method="POST" action="{{route('admin.DietaryAllowance.store')}}" enctype="multipart/form-data" data-parsley-validate novalidate>
                            @csrf
                            @method('POST')
                            <input type="hidden" name="age_category_id" value="{{$age_category_id}}">
