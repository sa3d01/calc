    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <a href="{{route('admin.DietaryAllowance.create',$age_category_id)}}">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    <td>{{$row->ageCategory->name}}</td>
                                    <td>{{$row->ageCategory->parent->name}}</td>
                                    @foreach($index_fields as $value)
                                        <td>{{$row->$value}}</td>
                                    @endforeach
                                    <td>
                                        <div class="button-list">
                                            <a href="{{route('admin.DietaryAllowance.edit',$row->id)}}">
